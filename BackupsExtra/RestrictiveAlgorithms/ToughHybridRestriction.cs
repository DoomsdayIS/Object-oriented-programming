...
{
    public class ToughHybridRestriction : IRestrictiveAlgorithm
    {
        public ToughHybridRestriction(DateTime dateTime, int count)
        {
            TimeLimit = dateTime;
            MaxPoints = count;
        }
        ...
        public List<RestorePoint> Check(BackupJobExtra backupJobExtra)
        {
            ...
            var restorePoints = restorePoints1.Union(restorePoints2).ToList();
